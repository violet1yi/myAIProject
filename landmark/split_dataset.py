...
def split_dataset():
    input_file = './anno/list_landmarks_celeba_strip.txt'
    output_file = open('10w-list_landmarks_celeba.txt', 'w')
...
if __name__ == '__main__':
    ...
    print('done')
    '''
    input = './anno/10w-list_landmarks_celeba.txt'
    out1 = './anno/data/9w_train_list_landmarks_celeba.txt'
    out2 = './anno/data/1w_val_list_landmarks_celeba.txt'
