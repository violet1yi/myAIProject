...
parser.add_argument('--num_samples', type=int, default=2000000, help='the number of train samples')
...
parser.add_argument('--checkpoint_dir', type=str, default='./CheckPoints/checkpoints_no_align_v3')
parser.add_argument('--logs_dir', type=str, default='./logs/logs_no_align_v3')
